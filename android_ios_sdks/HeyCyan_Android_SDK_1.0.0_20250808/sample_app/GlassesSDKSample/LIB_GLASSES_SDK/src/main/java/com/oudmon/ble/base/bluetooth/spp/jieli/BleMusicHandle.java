...
public class BleMusicHandle {
        ...
        public void onSerialRead(byte[] data) {
            if (data != null) {
                ...
                if ((data[0] & 0xff) == 0xbc && data[1] == 0x31) {
                    ...
                    //bc802f00e9bc 01 03 00 00 0c0f5cf48b2e007400780074000c780075002e007400780074001062600d5930528c542e00740078007400
    ...
    private int mPackageLength=244;
    ...
    private static BleMusicHandle mInstance;

    public static BleMusicHandle getInstance() {
        if (mInstance == null) {
            synchronized (BleMusicHandle.class) {
                if (mInstance == null) {
                    mInstance = new BleMusicHandle();
                }
            }
        }
        return mInstance;
